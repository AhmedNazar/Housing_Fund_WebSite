<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RightSideBar.ascx.cs" Inherits="UserControl_RightSideBar" %>
            ...
            <ul class="sidemenu  page-header-fixed" data-keep-expanded="false" data-auto-scroll="true"
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link nav-toggle"><i class="material-icons">person</i>
                        <span class="title">التقديم</span> <span class="arrow"></span>
                    </a>
                    <ul class="sub-menu">
                        <li class="nav-item">
                            <a href="RegisterationForm.aspx" class="nav-link "><span class="title">استمارة التقديم</span>
                            </a>
                        </li>
                        <%--<li class="nav-item">
                            <a href="ViewInfo.aspx" class="nav-link "><span class="title">عرض معلومات المتقدمين</span>
                            </a>
                        </li>--%>
                        <li class="nav-item">
                            <a href="ViewInfo.aspx" class="nav-link "><span class="title">تعديل معلومات المتقدم</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="Attachments.aspx" class="nav-link "><span class="title">تحميل الوثائق</span>
                            </a>
                        </li>
                    </ul>
                </li>
