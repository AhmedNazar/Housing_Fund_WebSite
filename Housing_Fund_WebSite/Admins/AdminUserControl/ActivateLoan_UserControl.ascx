<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ActivateLoan_UserControl.ascx.cs" Inherits="Admins_AdminUserControl_ActivateLoan_UserControl" %>
<div class="col-xs-12">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 text-right">
                        <asp:Label ID="Label5" runat="server" Text="حالة الحصة / الوجبة"></asp:Label>
                        <asp:DropDownList ID="ddl_Status" ValidationGroup="step1" CssClass="form-control" runat="server" DataSourceID="DS_Status" DataTextField="status_title" DataValueField="status_id"></asp:DropDownList>
                        <%--<asp:TextBox ID="txt_pDate" ValidationGroup="step1" CssClass="form-control" runat="server"></asp:TextBox>--%>
                        <asp:SqlDataSource runat="server" ID="DS_Status" ConnectionString='<%$ ConnectionStrings:CS %>' SelectCommand="SELECT * FROM [Status_Table]"></asp:SqlDataSource>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" ValidationGroup="step1" ControlToValidate="ddl_Status" ForeColor="Red" runat="server" ErrorMessage="الرجاء ملئ الحقل"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="row clearfix jsdemo-notification-button">
                    <div class="col-md-12 p-t-20 ">
                        <asp:Button ID="SaveButton" OnClick="SaveButton_Click" ValidationGroup="step1" CssClass="btn btn-dropbox btn-circle-left" runat="server" Text="تفعيل الحصة" />
                        <hr />
                    </div>
                </div>
                ...
                <asp:GridView ID="GridView1" runat="server" HeaderStyle-HorizontalAlign="Center" CssClass="table table-striped table-bordered table-hover table-checkable order-column valign-middle" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" DataKeyNames="lo_id">
                    <Columns>
                        ...
                        <asp:BoundField DataField="status_title" HeaderText="حالة الحصة / الوجبة" SortExpression="status_title">
                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
                    </Columns>
                ...
                <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:CS %>' SelectCommand="SELECT dbo.Loan_Table.lo_id, dbo.Loan_Table.gov_id, dbo.Loan_Table.lo_name, dbo.Loan_Table.lo_size, dbo.Loan_Table.lo_register, dbo.Loan_Table.lo_sizein, dbo.Loan_Table.lo_sizeacc, dbo.Loan_Table.lo_sizereg, dbo.Loan_Table.lo_sizeback, 
                  dbo.Loan_Table.lo_startdate, dbo.Loan_Table.lo_enddate, dbo.Loan_Table.type_id, dbo.Loan_Table.status_id, dbo.LoanType_Table.type_name, dbo.Governorate_Table.gov_name, dbo.Status_Table.status_title
FROM     dbo.Loan_Table INNER JOIN
                  dbo.LoanType_Table ON dbo.Loan_Table.type_id = dbo.LoanType_Table.type_id INNER JOIN
                  dbo.Governorate_Table ON dbo.Loan_Table.gov_id = dbo.Governorate_Table.gov_id INNER JOIN
                  dbo.Status_Table ON dbo.Loan_Table.status_id = dbo.Status_Table.status_id
Where lo_id = @lo_id"
                    ...
                    <SelectParameters>
                        <asp:QueryStringParameter QueryStringField="lo_id" Name="lo_id"></asp:QueryStringParameter>
                    </SelectParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="gov_id" Type="Int32"></asp:Parameter>
                        <asp:Parameter Name="lo_size" Type="Int32"></asp:Parameter>
